package com.example.anamika.storeandsend.service;
...
import com.example.anamika.storeandsend.model.Util;
import com.example.anamika.storeandsend.rest.ApiClient;
import com.example.anamika.storeandsend.rest.ApiInterface;
    ...
    public void onLocationChanged(Location location) {
       ...
       // currentDateTime = com.example.aarya.fieldofficersurveilance.model.Util.getDateTime();
        ...
        Call<List<Response>> call = apiService.sendGpsData(currentLat+"", currentLng+"",deviceNum,
                mProgressStatus+ "", currentDateTime,currentAcc+"","false",
